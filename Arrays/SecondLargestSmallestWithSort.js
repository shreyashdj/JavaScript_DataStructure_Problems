...
console.log(numberArray.sort());          // printing array after sort

console.log("\n Smallest Element : " + numberArray[0]);
console.log(" Second Smallest Element : " + numberArray[1]);
console.log(" Second Largest Element : " + numberArray[numberArray.length-2]);
console.log(" Largest Element : " + numberArray[numberArray.length-1] + "\n");